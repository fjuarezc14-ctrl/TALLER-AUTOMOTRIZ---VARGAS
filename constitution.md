...
* **Frontend**: JavaScript (ES Modules), Vite, CSS3.
* **Backend**: Node.js, Express v5 (ES Modules).
* **Base de Datos**: PostgreSQL 16 (Consultas parametrizadas con `pg`).
* **Infraestructura & Contenedores**: Docker, Docker Compose, Nginx.
