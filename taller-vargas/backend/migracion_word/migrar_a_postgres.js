...
// Configuración de conexión (detecta si corre en Docker o en Host local)
...
async function migrar() {
  ...
  const displayTarget = dbConfig.connectionString ? dbConfig.connectionString.replace(/:[^:@]+@/, ':****@') : `${dbConfig.host}:${dbConfig.port}/${dbConfig.database}`;
  console.log(`   Destino: ${displayTarget} | Modo: ${IS_DRY_RUN ? 'DRY-RUN (Simulación)' : 'REAL (Escritura activa)'}`);
  console.log('================================================================\n');
